...
4. Infisical `/frontend/github-actions/` 경로에 `FRONT_SERVER_HOST`, `FRONT_SERVER_USER`, `FRONT_DEPLOY_DIR`, `FRONT_SHELL_FILE`, `FRONT_TAR_FILE`, `FRONT_SSH_PRIVATE_KEY` 등록
5. 서버에 배포 shell 스크립트 배치
...
(프로젝트)    /frontend/github-actions/  FRONT_SERVER_HOST, FRONT_SERVER_USER,
                                         FRONT_DEPLOY_DIR, FRONT_SHELL_FILE (PM2만),
...
(프로젝트)    /backend/github-actions/   BACK_SERVER_HOST, BACK_SERVER_USER,
                                         BACK_DEPLOY_DIR, BACK_SHELL_FILE (PM2만),
